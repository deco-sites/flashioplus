...
const variants = {
  primary:
    "h-[36px] px-3 rounded bg-interactive font-button text-button text-default-inverse border-transparent hover:bg-default hover:text-default hover:border-interactive active:bg-interactive active:text-default-inverse active:border-transparent focus:outline-none ",
  secondary:
  ...
  toggle:
    "flex flex-col font-semibold uppercase group px-[24px] focus:outline-none pt-[5px] border-0 rounded-[0px] text-[12px]",
};
